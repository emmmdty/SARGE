...
from sage_dee.v2.data_interface.jsonl import iter_jsonl, write_jsonl
from sage_dee.v2.diagnostics.gpu_monitor import GpuMemoryMonitor, ResourceMonitorConfig, VramLimitExceeded
...
from sage_dee.v2.getm.prompt_builder import (
...
from sage_dee.v2.getm.sft_dataset import build_sft_training_examples
...
def _generation_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    use_response_prefix = _as_bool(raw.get("use_response_prefix", True))
