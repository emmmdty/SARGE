...
from sage_dee.v2.getm.prompt_builder import DEFAULT_GETM_OUTPUT_FORMAT, build_getm_prompt, normalize_output_format
...
def _generation_config(config: dict[str, Any] | None) -> dict[str, Any]:
    raw = ((config or {}).get("getm") or {}).get("generation") or {}
    return {
