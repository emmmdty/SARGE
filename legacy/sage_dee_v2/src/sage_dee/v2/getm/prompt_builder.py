...
from sage_dee.v2.lesp.slot_plan import SlotPlanDocument, slot_plan_to_dict
...
GETM_OUTPUT_FORMATS = frozenset({"minimal_text", "argument_object"})
    ...
    *,
    ...
    return (
        ...
        *_shared_event_instructions(
        ...
        _no_event_instruction(normalized_baseline_mode),
...
def _no_event_instruction(baseline_mode: str) -> str:
    if normalize_prompt_baseline_mode(baseline_mode) == "direct_json":
