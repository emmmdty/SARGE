# DuEE-Fin Test Seed Stability Draft

Metric values are percentages. Mean and std use seeds `13`, `17`, and `42`; std is sample standard deviation. These rows support stability reporting and do not replace the seed-13 main-table row.
